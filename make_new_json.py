...
animes = all["animes"]
fir_anime = animes[-1]
name = fir_anime['anime_block_subject']
print(name)
...
#                     str(anime_id)+".mp4"
#             anime_one_data_dir = {
#                 "anime_one_link": anime_one_link, "anime_one_thumbnail": anime_one_thumbnail, "anime_one_title": anime_one_title, "anime_one_updated_date": anime_one_updated_date, "anime_view_link": anime_view_link
#             }
